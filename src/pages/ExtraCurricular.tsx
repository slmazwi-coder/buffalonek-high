...
const ProgramCard: React.FC<{ prog: any }> = ({ prog }) => (
  ...
  >
    <div className="aspect-video bg-[#FDF9EC] flex items-center justify-center relative">
      <prog.icon size={64} className="text-[#009999]/40" />
      <div className="absolute inset-0 bg-[#D4AF37] flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
    ...
    <div className="p-6">
      <div className="flex items-center gap-2 mb-2">
        <span className={`text-xs font-bold uppercase tracking-wider px-2 py-0.5 rounded-full ${
          prog.category === 'Sport' ? 'bg-[#FFF3CC] text-[#009999]' : 
          prog.category === 'Academic' ? 'bg-[#FDF9EC] text-[#009999]' :
    ...
    <div className="py-16 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-center text-xl text-gray-600 mb-16 max-w-3xl mx-auto">
          At Buffalo-Nek High School, we believe in a holistic education. Our extra-curricular programs are designed to discover and nurture the diverse talents of our learners.
        </p>

        {/* Sports */}
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-[#009999] mb-8 flex items-center gap-3">
            <Dumbbell className="text-[#009999]" /> Sports
          </h2>
        ...
        <section className="mb-16">
          <h2 className="text-2xl font-bold text-[#009999] mb-8 flex items-center gap-3">
            <BookOpen className="text-[#009999]" /> Academic Extra-Curricular
          </h2>
        ...
        <section className="mb-24">
          <h2 className="text-2xl font-bold text-[#009999] mb-8 flex items-center gap-3">
            <Music className="text-[#009999]" /> Arts & Culture
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          <section>
            <h2 className="text-3xl font-bold text-[#009999] mb-8 flex items-center gap-3">
          ...
          <section>
            ...
            <div className="bg-[#D4AF37] rounded-3xl p-8 text-white">
              <p className="text-lg italic mb-8 text-[#FFF3CC]">
                "Recognizing those who have gone above and beyond in representing Buffalo-Nek High School at regional, provincial, and national levels."
              </p>

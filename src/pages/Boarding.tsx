...
const inp = 'border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/40 focus:border-[#009999] transition w-full bg-white';
...
const SectionHeading = ({ title }: { title: string }) => (
  <div className="flex items-center gap-2 pb-2 border-b-2 border-[#009999]/20 mb-5">
    <FileText size={15} className="text-[#009999] shrink-0" />
...
const StepBadge = ({ num, label, active, done }: {
  ...
  <div className="flex items-center gap-2">
    <div className={`w-7 h-7 rounded-full flex items-center justify-center text-xs font-black border-2 transition-all
      ${done ? 'bg-[#D4AF37] border-[#009999] text-white'
      : active ? 'bg-white border-white text-[#009999]'
...
const FileUploadRow = ({ label, required, fileKey, files, onChange }: {
  ...
  return (
    <div className={`flex items-center gap-3 p-3 rounded-xl border-2 transition
      ${file ? 'border-[#009999] bg-[#FDF9EC]'
      : required ? 'border-dashed border-red-300 bg-red-50/30'
      : 'border-dashed border-gray-300 bg-gray-50'}`}>
      <div className={`shrink-0 w-8 h-8 rounded-lg flex items-center justify-center
        ${file ? 'bg-[#D4AF37] text-white' : 'bg-gray-200 text-gray-400'}`}>
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className={`text-xs mt-0.5 truncate ${file ? 'text-[#009999]' : 'text-gray-400'}`}>
          {file ? file.name : 'No file chosen'}
        </div>
      </div>
      <label className="shrink-0 text-xs font-bold text-[#009999] cursor-pointer hover:underline">
        {file ? 'Change' : 'Upload'}
  ...
  if (submitted) {
    return (
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          <div className="w-20 h-20 bg-[#FFF3CC] text-[#009999] rounded-full flex items-center justify-center mx-auto mb-6">
            <CheckCircle size={48} />
          </div>
  ...
  return (
    <div className="py-12 sm:py-16 bg-gray-50">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Info banner */}
        <div className="mb-6 bg-[#FDF9EC] border border-[#D4AF37] rounded-2xl p-4 flex gap-3">
        ...
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
          ...
          {/* Header */}
          <div className="bg-[#D4AF37] px-8 py-7 text-white">
              ...
              >
                    ...
                    <section>
                      ...
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <Field label="Name & Address of School Admitted To" className="sm:col-span-2">
                          <input className={inp} value={learner.schoolNameAndAddress} onChange={e => patchL('schoolNameAndAddress', e.target.value)} placeholder="Buffalo-Nek High School, Igoga Location, Matatiele" />
                        </Field>
                        ...
                        <table className="w-full text-sm">
                          <thead>
                            <tr>
                              ...
                              <th className="text-left px-3 py-2 bg-[#FDF9EC] text-xs font-bold text-[#009999] uppercase">Father / Guardian / Responsible Person</th>
                              <th className="text-left px-3 py-2 bg-[#FDF9EC] text-xs font-bold text-[#009999] uppercase">Mother / Relative</th>
                            </tr>
                          </thead>
                          <tbody>
                            {([
                  ...
                  <>
                    ...
                    <section>
                      ...
                      <button type="button" onClick={() => setChildren(p => [...p, { surname:'',firstName:'',dob:'',grade:'',school:'' }])}
                        className="mt-2 text-xs text-[#009999] font-semibold hover:underline">+ Add another child</button>
                    </section>
                ...
                {step === 3 && (
                  <>
                    ...
                    <section className="bg-[#FDF9EC] border-2 border-[#D4AF37] rounded-2xl p-6">
                      <div className="flex gap-4 items-start">
                        <div className="w-12 h-12 bg-[#FFF3CC] text-[#009999] rounded-xl flex items-center justify-center shrink-0">
                          <Download size={22} />
                        </div>
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-[#009999] mt-3">
                ...
                <div className="flex items-center justify-between pt-2 border-t border-gray-100">
                  ...
                  {step < 3 ? (
                    <button type="button" onClick={goNext}
                      className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-[#D4AF37] text-white text-sm font-bold hover:bg-[#B89200]/90 transition shadow">
                      Next <ChevronRight size={16} />
                    </button>
                  ) : (
                    <button type="submit" disabled={submitting}
                      className="inline-flex items-center gap-2 px-7 py-2.5 rounded-xl bg-[#D4AF37] text-white text-sm font-bold hover:bg-[#B89200]/90 disabled:opacity-60 disabled:cursor-not-allowed transition shadow">
                      {submitting

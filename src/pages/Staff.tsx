...
const StaffCard = ({ member }: { member: StaffMember }) => (
  <div
    ...
    style={ { background: '#FFFBEF', border: '1px solid #009999' } }
  >
    {/* Avatar */}
    <div
      className="w-24 h-24 rounded-full flex items-center justify-center mb-4 overflow-hidden"
      style={ { background: '#FDF9EC', border: '3px solid #009999' } }
    >
      {member.image ? (
        <img
          src={member.image}
        ...
        <User size={40} style={ { color: '#009999', opacity: 0.5 } } />
      )}
    </div>

    <h3 className="text-sm font-bold leading-tight" style={ { color: '#009999' } }>
      {member.name}
    </h3>
    ...
    {member.subject && (
      <span
        ...
        style={ { background: '#FDF9EC', color: '#009999', border: '1px solid #009999' } }
      >
        {member.subject}
      </span>
    )}
    ...
    <div className="min-h-screen py-12 px-4" style={ { background: '#FDF9EC' } }>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10">
          <h1 className="text-4xl font-extrabold tracking-tight mb-3" style={ { color: '#009999' } }>
            Our Staff
          </h1>
          <div className="w-16 h-1 mx-auto rounded-full mb-4" style={ { background: '#D4AF37' } } />
          <p className="text-gray-500 text-base max-w-2xl mx-auto">
            Meet the dedicated team of educators and support staff at Buffalo-Nek High School.
          </p>
        </div>
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-10">
          {categories.map(cat => (
            <button
              ...
              style={
                activeCategory === cat
                  ? { background: '#D4AF37', color: '#009999', border: '2px solid #D4AF37', fontWeight: 700 }
                  : { background: '#FFFBEF', color: '#009999', border: '2px solid #009999' }
              }

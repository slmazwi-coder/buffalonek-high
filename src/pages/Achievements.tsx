...
const StudentAvatar = ({ image, name, year }: { image: string; name: string; year: string }) => {
  ...
  return (
    <div className="aspect-[3/4] sm:aspect-square w-full relative overflow-hidden bg-gray-100 rounded-2xl shadow-lg border border-gray-100 flex items-center justify-center group">
      ...
      <div className="absolute top-0 right-0 bg-[#FDF9EC] p-4 text-[#009999] opacity-0 group-hover:opacity-100 transition-opacity">
        <Award size={24} />
      </div>
    </div>
  );
    ...
    <div className="py-12 sm:py-16 bg-white min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <section className="mb-16 sm:mb-24">
          <div className="bg-[#009999] border-2 border-[#D4AF37] rounded-3xl p-6 sm:p-8 md:p-12 relative overflow-hidden shadow-xl">
            <div className="absolute top-0 right-0 p-12 opacity-5 pointer-events-none">
              <Star size={200} className="text-[#009999]" />
            </div>
            <div className="relative z-10 flex flex-col md:flex-row items-center gap-8 md:gap-10">
              <div className="w-32 h-32 sm:w-40 sm:h-40 bg-[#FDEEA0] rounded-full flex flex-col items-center justify-center text-[#009999] border-8 border-white shadow-lg shrink-0">
              ...
              <div>
                <div className="flex flex-wrap items-center justify-center md:justify-start gap-2 text-[#D4AF37] font-bold uppercase tracking-widest text-sm mb-2">
                  <Star size={16} fill="currentColor" /> 2025 Matric Highlight <Star size={16} fill="currentColor" />
                </div>
                <h2 className="text-3xl md:text-5xl font-black text-[#D4AF37] mb-4 text-center md:text-left">
                ...
                <p className="text-base sm:text-lg text-gray-700 max-w-2xl italic leading-relaxed text-center md:text-left">
                  "Buffalo-Nek High School continues to focus on steady improvement, learner support, and high academic standards."
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="mb-20 sm:mb-32">
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#009999] mb-4 flex items-center justify-center gap-4">
            ...
            {hallOfFame.slice(0, 8).map((student, idx) => (
              ...
              >
                ...
                <div className="p-6 text-center">
                  ...
                  <div className="text-[#009999] text-sm font-bold mb-3 flex items-center justify-center gap-1">
        ...
        <section className="mb-20 sm:mb-32">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-8 sm:mb-10">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#009999] flex items-center gap-3">
              <BarChart3 className="text-[#009999]" /> Matric Results Summary
            </h2>
              ...
              {(['2025', '2024', '2023'] as const).map((year) => (
                <button
                  ...
                  className={`px-4 sm:px-6 py-2 rounded-lg font-bold transition-all text-sm sm:text-base ${
                    activeResultsYear === year ? 'bg-[#D4AF37] text-white shadow-md' : 'text-gray-600 hover:bg-gray-200'
                  }`}
                >
                  {year}
                </button>
          ...
          <AnimatePresence mode="wait">
            ...
            >
              {!currentResults ? (
                ...
                <>
                  <div className="bg-[#D4AF37] rounded-3xl p-6 sm:p-8 md:p-12 text-white shadow-2xl relative overflow-hidden mb-10 sm:mb-12">
                      ...
                      {currentResults.subjects.map((stat, i) => (
                        <div key={i} className="bg-white p-5 rounded-xl border border-gray-100 shadow-sm">
                          <div className="flex justify-between items-center mb-3 gap-3">
                            ...
                            <span className="text-[#009999] font-bold">{stat.rate}%</span>
                          </div>
        ...
        <section>
          <div className="text-center mb-10 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl font-bold text-[#009999] flex items-center justify-center gap-3 mb-4">
              <Calendar className="text-[#009999]" /> Top Achievers Timeline
            </h2>
              ...
              <button
                ...
                className={`px-4 sm:px-5 py-2 rounded-full font-bold transition-all text-sm ${
                  activeAchieversYear === year
                    ...
                    : 'bg-white text-gray-500 border border-gray-200 hover:border-[#009999] hover:text-[#009999]'
                }`}
              >
                {year}
              </button>
                ...
                achieversByYear[activeAchieversYear].map((person, i) => (
                  <div key={i} className="text-center">
                    ...
                    <div className="mt-4">
                      ...
                      <p className="text-xs font-semibold text-[#009999] uppercase tracking-wider">{person.title}</p>
                    </div>
                  </div>
                ))
              ) : (

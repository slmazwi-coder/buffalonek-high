...
const inp =
  'border border-gray-300 rounded-lg px-3 py-2 text-sm text-gray-800 focus:outline-none focus:ring-2 focus:ring-[#D4AF37]/40 focus:border-[#009999] transition w-full bg-white';
...
const SectionHeading = ({ icon, title }: { icon: React.ReactNode; title: string }) => (
  <div className="flex items-center gap-2 pb-2 border-b border-gray-200 mb-4">
    <span className="text-[#009999]">{icon}</span>
      ...
      <div className="py-20 flex items-center justify-center min-h-[60vh]">
        ...
        >
          ...
          <p className="text-gray-600 mb-8">
            Thank you for applying to Buffalo-Nek High School. We have received your application and will be in contact shortly.
          </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-5">
              <div>
                ...
                <p className="text-white/70 text-sm mt-1">
                  Buffalo-Nek High School &nbsp;·&nbsp; Igoga Location, Matatiele 4730
                </p>
              </div>
                  ...
                  <>
                    ...
                    <div className="flex items-center gap-3">
                      <button
                        ...
                        className="text-sm font-semibold text-[#009999] underline underline-offset-2"
                      >
                          ...
                          return (
                            <div
                              ...
                              className={`relative flex items-center gap-3 p-3 rounded-xl border-2 transition
                                ${file
                                  ? 'border-[#009999] bg-[#FDF9EC]'
                                  : field.required
                                    ? 'border-dashed border-red-300 bg-red-50/40'
                                    : 'border-dashed border-gray-300 bg-gray-50'}`}
                            >
                              <div className={`shrink-0 w-8 h-8 rounded-lg flex items-center justify-center ${file ? 'bg-[#D4AF37] text-white' : 'bg-gray-200 text-gray-400'}`}>
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                {file && <div className="text-xs text-[#009999] truncate mt-0.5">{file.name}</div>}

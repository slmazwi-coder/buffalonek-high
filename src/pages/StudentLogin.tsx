...
export const StudentLogin = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    sessionStorage.setItem('jojo_student_portal_student_number', sn);
    navigate('/student');
  };
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      <div className="bg-gray-800 rounded-2xl shadow-2xl p-8 w-full max-w-md border border-gray-700">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-sm mt-1">Jojo</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 bg-gray-700 border border-gray-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#D4AF37] focus:border-transparent"
          ...
          <button
            type="submit"
            className="w-full bg-[#D4AF37] text-white py-3 rounded-xl font-bold hover:bg-[#540D1C] transition-colors"
          >
            Sign In
          </button>
        </form>

...
export const Footer = () => {
  return (
    <footer className="pt-12 pb-8 w-full" style={ { background: '#009999', borderTop: '4px solid #D4AF37' } }>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 mb-10">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <div className="flex items-center gap-3 mb-3">
              ...
              <div>
                <h3 className="text-base font-bold leading-tight" style={ { color: '#D4AF37' } }>
            ...
            <div className="flex gap-3 mt-4">
              <a href="https://www.facebook.com/JojoSeniorSecondarySchool/" target="_blank" rel="noreferrer"
                ...
                style={ { background: 'rgba(245,197,24,0.15)', color: '#D4AF37' } }
                aria-label="Facebook">
                <Facebook size={18} />
              </a>
          ...
          <div>
            <h4 className="text-sm font-bold mb-4 pb-2 uppercase tracking-wide"
              style={ { color: '#D4AF37', borderBottom: '1px solid rgba(245,197,24,0.25)' } }>
              Contact Us
            </h4>
            <ul className="space-y-3 text-sm" style={ { color: 'rgba(245,197,24,0.8)' } }>
              <li className="flex items-start gap-2">
                <MapPin className="shrink-0 mt-0.5" size={16} />
                <span>Njijini A/A, Emthonjeni Location, Mount Frere, Eastern Cape 4735</span>
              </li>
              <li className="flex items-center gap-2">
                <Phone size={16} className="shrink-0" />
                <span>+27 72 417 6535 / 073 454 3888</span>
              </li>
              <li className="flex items-start gap-2">
        ...
        <div className="pt-6 text-center text-xs" style={ { borderTop: '1px solid rgba(245,197,24,0.15)', color: 'rgba(245,197,24,0.5)' } }>
          <p>© {new Date().getFullYear()} Buffalo-Nek High School. All Rights Reserved.</p>
          <Link to="/admin/login"

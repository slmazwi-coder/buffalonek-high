  ...
  return (
    <div>
      ...
      <section className="bg-gray-800 border border-gray-700 rounded-2xl p-6 mb-6">
        <div className="flex items-center justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-[#D4AF37] text-white px-4 py-2 rounded-xl text-sm font-medium hover:bg-[#540D1C]"
          >
          ...
          <div className="bg-gray-700 rounded-xl p-4 mb-4 space-y-3">
            ...
            <div className="flex flex-wrap items-center justify-between gap-4 pt-2 border-t border-gray-600">
              <button 
                onClick={saveHall} 
                disabled={isScanning}
                className="flex items-center gap-2 bg-[#D4AF37] text-white px-4 py-2 rounded-lg text-sm font-medium hover:bg-[#540D1C] disabled:opacity-50"
              >
                {isScanning ? (
      ...
      <div className="bg-gray-800 border border-gray-700 rounded-2xl p-6">
        <p className="text-gray-400 text-sm">💡 To edit yearly results data and subject pass rates, update the code in <code className="text-[#009999]">Achievements.tsx</code> directly until Supabase is connected.</p>
      </div>
    </div>
  );
};

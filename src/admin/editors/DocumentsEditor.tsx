  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <button onClick={() => setShowUpload(!showUpload)} className="flex items-center gap-2 bg-[#D4AF37] text-white px-4 py-2 rounded-xl font-medium hover:bg-[#540D1C]">
        ...
        <div className="bg-gray-800 border border-gray-600 rounded-2xl p-6 mb-8">
          ...
          <div className="flex items-center gap-4">
            <button 
              ...
              className="bg-[#D4AF37] text-white px-6 py-2 rounded-xl font-medium hover:bg-[#540D1C] disabled:opacity-50"
            >
              {isScanning ? (

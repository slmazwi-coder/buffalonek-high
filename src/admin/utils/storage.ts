...
const SCHOOL_DATA_VERSION = 'buffalonek-v1';
...
const defaultContact: ContactInfo = {
  address: 'Njijini A/A, Emthonjeni Location, Mount Frere, 5090',
  phone: '+27 72 417 6535 / (039) 254 8224',
  email: 'Principal.200300062@ecschools.org.za',
  monThu: '07:30 - 15:30',
  friday: '07:30 - 15:30',
  weekend: 'Closed',
};
...
const defaultAbout: AboutInfo = {
  historyParagraphs: [
    'Buffalo-Nek High School is a public senior secondary school located at Dundee A/A, Mount Ayliff, in the Alfred Nzo West Education District of the Eastern Cape.',
    'Operating as a No-Fee school, Buffalo-Nek High School is committed to academic excellence, community values, and nurturing the potential of every learner. Our motto — "Legacy of Leadership and Learning" — inspires us to reach for greatness.',
  ...
  principalName: 'M.A. Mdondolo',
  principalTitle: 'Principal',
  principalMessage: [
    'Welcome to Buffalo-Nek High School. Our institution stands as a beacon of academic excellence and community spirit in the heart of Mount Ayliff.',
    'At Buffalo-Nek High School, we believe that every learner has the potential to reach for the sky. Our dedicated team of 46 teachers works tirelessly to nurture talent, foster creativity, and build responsible citizens.',
    'Together, we create an environment where "We are unity" is not just a phrase, but a way of life. Our learners leave Buffalo-Nek High School not only with knowledge but with values that will serve them throughout their lives.',
  ],
};
